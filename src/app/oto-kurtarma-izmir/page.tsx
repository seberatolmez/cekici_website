...
const services = [
  {
    title: 'Profesyonel Kurtarma Hizmeti',
    description: 'İzmir\'in her noktasında 7/24 profesyonel oto kurtarma hizmeti sunuyoruz. Modern kurtarma ekipmanlarımız ve uzman ekibimizle yanınızdayız.',
  ...
  {
    title: 'Stratejik Konumlandırma',
    description: 'İzmir\'in stratejik noktalarında konumlandırılmış kurtarma ekiplerimiz ile hızlı müdahale sağlıyoruz. Ortalama 15-20 dakika içinde yanınızdayız.',
    image: '/photo/p20.png',
    features: [
...
export default function OtoKurtarmaIzmirPage() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6 text-center lg:text-left">
              ...
              <p className="text-xl md:text-2xl text-blue-100 font-light">
                7/24 profesyonel kurtarma hizmetleri
              </p>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg prose-blue mx-auto">
            <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">
              Oto Kurtarma İzmir Hizmetlerimiz
            </h2>
